...
import static com.foysaltech.xrecyclerview.BaseRefreshHeader.STATE_DONE;
...
public class XRecyclerView extends RecyclerView {
    ...
    public void addHeaderView(View view) {
        if (mHeaderViews == null || sHeaderTypes == null) return;
    ...
    public void removeHeaderView(@NonNull View v) {
        if (mHeaderViews == null || sHeaderTypes == null || v == null) return;
    ...
    public void refreshComplete() {
        if (mRefreshHeader != null) mRefreshHeader.refreshComplete();
        setNoMore(false);
    }
    ...
    public Adapter getAdapter() {
        if (mWrapAdapter != null) return mWrapAdapter.getOriginalAdapter();
        else return null;
    }
    ...
    private boolean isOnTop() {
        if (mRefreshHeader == null) return false;
